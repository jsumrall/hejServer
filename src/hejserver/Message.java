 ...
 * <pre><code>
 * hejserver.Message message = new hejserver.Message.Builder().build();
 * </pre></code>
 *
 * <strong>hejserver.Message with optional attributes:</strong>
 * <pre><code>
 * hejserver.Message message = new hejserver.Message.Builder()
 ...
 * </pre></code>
 *
 * <strong>hejserver.Message with optional attributes and payload data:</strong>
 * <pre><code>
 * hejserver.Message message = new hejserver.Message.Builder()
 *    .collapseKey(collapseKey)
 *    .timeToLive(3)
...
public final class Message implements Serializable {
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("hejserver.Message(");
        if (collapseKey != null) {
