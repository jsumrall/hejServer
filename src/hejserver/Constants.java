 ...
 */
/**
 * hejserver.Constants used on GCM service communication.
 */
public final class Constants {
     ...
     * hejserver.Sender should always add the registration_id to the request.
     */
    public static final String ERROR_MISSING_REGISTRATION = "MissingRegistration";

    /**
     * Bad registration_id. hejserver.Sender should remove this registration_id.
     */
     ...
     * hejserver.Sender should stop sending messages to this device and delete the
